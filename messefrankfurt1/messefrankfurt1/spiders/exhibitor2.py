...
class Exhibitor2Spider(scrapy.Spider):
    name = "exhibitor2"
    allowed_domains = ["texworld-paris.fr.messefrankfurt.com"]
    start_urls = [
        f"https://api.messefrankfurt.com/service/esb_api/exhibitor-service/api/2.1/public/exhibitor/search?language=en-GB&q=&orderBy=name&pageNumber={i}&pageSize=25&showJumpLabels=true&findEventVariable=APPARELSOURCINGPARISSPRING"
